...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ccmsg.EscrowOfferRequest.toObject = function(includeInstance, msg) {
        var obj = {
            ...
            publisherCacheAddr: jspb.Message.getFieldWithDefault(msg, 5, ''),
...
proto.ccmsg.EscrowOfferRequest.deserializeBinaryFromReader = function(msg, reader) {
    while (reader.nextField()) {
        ...
        switch (field) {
            ...
            case 5:
                var value = /** @type {string} */ (reader.readString());
                msg.setPublisherCacheAddr(value);
                break;
            case 6:
                var value = /** @type {number} */ (reader.readUint64());
                msg.setStartBlock(value);
...
proto.ccmsg.EscrowOfferRequest.serializeBinaryToWriter = function(message, writer) {
    ...
    f = message.getPublisherCacheAddr();
    if (f.length > 0) {
        writer.writeString(5, f);
    }
    f = message.getStartBlock();
...
/**
 * optional string publisher_cache_addr = 5;
 * @return {string}
 */
proto.ccmsg.EscrowOfferRequest.prototype.getPublisherCacheAddr = function() {
    return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ''));
};

/** @param {string} value */
proto.ccmsg.EscrowOfferRequest.prototype.setPublisherCacheAddr = function(value) {
    jspb.Message.setProto3StringField(this, 5, value);
};
