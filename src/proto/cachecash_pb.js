...
proto.ccmsg.BatchSignature = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.ccmsg.BatchSignature.repeatedFields_, null)
}
...
proto.ccmsg.ClientCacheRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.ccmsg.ClientCacheRequest.oneofGroups_)
}
...
proto.ccmsg.ClientCacheResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.ccmsg.ClientCacheResponse.oneofGroups_)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.EscrowInfo.toObject = function(includeInstance, msg) {
    var obj = {
      publicKey: (f = msg.getPublicKey()) && proto.ccmsg.PublicKey.toObject(includeInstance, f),
      publisherPublicKey:
        (f = msg.getPublisherPublicKey()) && proto.ccmsg.PublicKey.toObject(includeInstance, f),
...
proto.ccmsg.EscrowInfo.prototype.addTicketsPerBlock = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.ccmsg.Segment, opt_index)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.TicketBundle.toObject = function(includeInstance, msg) {
    var obj = {
      remainder:
        (f = msg.getRemainder()) && proto.ccmsg.TicketBundleRemainder.toObject(includeInstance, f),
      ...
      batchSig: (f = msg.getBatchSig()) && proto.ccmsg.BatchSignature.toObject(includeInstance, f),
      bundleSignerCert:
        (f = msg.getBundleSignerCert()) && proto.ccmsg.Certificate.toObject(includeInstance, f),
      cacheInfoList: jspb.Message.toObjectList(
        msg.getCacheInfoList(),
        proto.ccmsg.CacheInfo.toObject,
        includeInstance
      ),
      metadata: (f = msg.getMetadata()) && proto.ccmsg.ObjectMetadata.toObject(includeInstance, f)
    }
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        ...
        reader.readMessage(value, proto.ccmsg.TicketBundleRemainder.deserializeBinaryFromReader)
...
proto.ccmsg.TicketBundle.prototype.addTicketL1 = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 6, opt_value, proto.ccmsg.TicketL1, opt_index)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.TicketBundleRemainder.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      puzzleInfo:
        (f = msg.getPuzzleInfo()) && proto.ccmsg.ColocationPuzzleInfo.toObject(includeInstance, f),
      clientPublicKey:
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 7:
        ...
        reader.readMessage(value, proto.ccmsg.ColocationPuzzleInfo.deserializeBinaryFromReader)
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.BatchSignature.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      signingKey: (f = msg.getSigningKey()) && proto.ccmsg.PublicKey.toObject(includeInstance, f)
    }
...
proto.ccmsg.BatchSignature.prototype.getPathDigestList_asU8 = function() {
  return /** @type {!Array<!Uint8Array>} */ (jspb.Message.bytesListAsU8(this.getPathDigestList()))
}
...
proto.ccmsg.TicketL2.prototype.addInnerSessionKey = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 3, opt_value, proto.ccmsg.BlockKey, opt_index)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.Certificate.toObject = function(includeInstance, msg) {
    var obj = {
      subjectPublicKey:
        (f = msg.getSubjectPublicKey()) && proto.ccmsg.PublicKey.toObject(includeInstance, f),
      escrowId: msg.getEscrowId_asB64(),
...
proto.ccmsg.TicketBundleSubdigests.prototype.getTicketL1DigestList_asB64 = function() {
  return /** @type {!Array<string>} */ (jspb.Message.bytesListAsB64(this.getTicketL1DigestList()))
}
...
proto.ccmsg.ContentResponse.prototype.getError = function() {
  return /** @type{?proto.ccmsg.Error} */ (jspb.Message.getWrapperField(this, proto.ccmsg.Error, 2))
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.ClientCacheRequest.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      ticketRequest:
        (f = msg.getTicketRequest()) && proto.ccmsg.TicketRequest.toObject(includeInstance, f),
      ticketL1: (f = msg.getTicketL1()) && proto.ccmsg.TicketL1.toObject(includeInstance, f),
      ticketL2: (f = msg.getTicketL2()) && proto.ccmsg.TicketL2Info.toObject(includeInstance, f),
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 2:
        ...
        reader.readMessage(value, proto.ccmsg.TicketBundleSubdigests.deserializeBinaryFromReader)
...
proto.ccmsg.ClientCacheRequest.prototype.setTicketRequest = function(value) {
  jspb.Message.setOneofWrapperField(this, 5, proto.ccmsg.ClientCacheRequest.oneofGroups_[0], value)
}
...
proto.ccmsg.ClientCacheRequest.prototype.setTicketL1 = function(value) {
  jspb.Message.setOneofWrapperField(this, 6, proto.ccmsg.ClientCacheRequest.oneofGroups_[0], value)
}
...
proto.ccmsg.ClientCacheRequest.prototype.setTicketL2 = function(value) {
  jspb.Message.setOneofWrapperField(this, 7, proto.ccmsg.ClientCacheRequest.oneofGroups_[0], value)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.ClientCacheResponse.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      l1Response:
        (f = msg.getL1Response()) && proto.ccmsg.ClientCacheResponseL1.toObject(includeInstance, f),
      l2Response:
        (f = msg.getL2Response()) && proto.ccmsg.ClientCacheResponseL2.toObject(includeInstance, f)
    }
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 3:
        ...
        reader.readMessage(value, proto.ccmsg.ClientCacheResponseData.deserializeBinaryFromReader)
        msg.setDataResponse(value)
        break
      case 4:
        var value = new proto.ccmsg.ClientCacheResponseL1()
        reader.readMessage(value, proto.ccmsg.ClientCacheResponseL1.deserializeBinaryFromReader)
        msg.setL1Response(value)
        break
      case 5:
        var value = new proto.ccmsg.ClientCacheResponseL2()
        reader.readMessage(value, proto.ccmsg.ClientCacheResponseL2.deserializeBinaryFromReader)
...
proto.ccmsg.ClientCacheResponse.prototype.setError = function(value) {
  jspb.Message.setOneofWrapperField(this, 2, proto.ccmsg.ClientCacheResponse.oneofGroups_[0], value)
}
...
proto.ccmsg.ClientCacheResponse.prototype.setDataResponse = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.ccmsg.ClientCacheResponse.oneofGroups_[0], value)
}
...
proto.ccmsg.ClientCacheResponse.prototype.setL1Response = function(value) {
  jspb.Message.setOneofWrapperField(this, 4, proto.ccmsg.ClientCacheResponse.oneofGroups_[0], value)
}
...
proto.ccmsg.ClientCacheResponse.prototype.setL2Response = function(value) {
  jspb.Message.setOneofWrapperField(this, 5, proto.ccmsg.ClientCacheResponse.oneofGroups_[0], value)
}
...
if (jspb.Message.GENERATE_TO_OBJECT) {
  ...
  proto.ccmsg.Chunk.toObject = function(includeInstance, msg) {
    var obj = {
      ...
      inline: (f = msg.getInline()) && proto.ccmsg.BlockSourceInline.toObject(includeInstance, f)
    }
  ...
  while (reader.nextField()) {
    ...
    switch (field) {
      ...
      case 20:
        ...
        reader.readMessage(value, proto.ccmsg.BlockSourceInline.deserializeBinaryFromReader)
        msg.setInline(value)
        break
      default:
        reader.skipField()
