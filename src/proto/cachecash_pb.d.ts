...
export class TicketBundle extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: TicketBundle, reader: jspb.BinaryReader): TicketBundle
}
...
export class TicketL2Info extends jspb.Message {
  ...
  static deserializeBinaryFromReader(message: TicketL2Info, reader: jspb.BinaryReader): TicketL2Info
}
...
export class TicketBundleSubdigests extends jspb.Message {
  ...
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> }
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> }
  static serializeBinaryToWriter(message: TicketBundleSubdigests, writer: jspb.BinaryWriter): void
...
export class ClientCacheResponse extends jspb.Message {
  ...
  static toObject(includeInstance: boolean, msg: ClientCacheResponse): ClientCacheResponse.AsObject
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> }
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> }
...
export class ClientCacheResponseData extends jspb.Message {
  ...
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> }
  static extensionsBinary: { [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message> }
  static serializeBinaryToWriter(message: ClientCacheResponseData, writer: jspb.BinaryWriter): void
